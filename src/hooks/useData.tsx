...
export const useData = () => {
  ...
  // Simulate login...
  const [token, setToken] = useState<string>("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NmQ3ZmRhM2Y1ZDY1MzkwODI2Y2M4YTYiLCJuYW1lIjoiSmltIiwiZW1haWwiOiJqaW1AaGVyZS5jb20iLCJpYXQiOjE3MjU0NTAzNzAsImV4cCI6MTcyNTQ1NzU3MH0.Xntz6sExRZVqCrdjWOEY1tbxbKPPxbyES0vDX52EiI0");
